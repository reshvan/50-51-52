...
function preload(){
  ...
  missionpassedImage = loadImage("missionpassed.png")
  backImage= loadImage("bg.jpg")
  killSound=loadSound("killSound.wav")
...
function setup() {
  ...
  missionfailed=createSprite(300,300)
  missionfailed.addImage(missionfailedImage)
  missionfailed.scale=2

  missionpassed=createSprite(300,300)
  missionpassed.addImage(missionpassedImage)
  missionpassed.scale=1
